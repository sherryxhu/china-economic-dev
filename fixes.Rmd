...
our_model = lmer(LOG_THOUSANDS_SHIFTED ~ CYEAR + URBAN + T1 + BUSINESS_IND + FARM_IND + 
    FISH_IND + LVST_IND + OTHR_IND + RETIRE_IND + SUB_IND + (1 | 
    HHID) + CYEAR * FARM_IND + CYEAR * RETIRE_IND + T1_23_IND * 
    CYEAR + T1_32_IND * CYEAR + CYEAR * BUSINESS_IND + T1_21_IND * 
    CYEAR + T1_31_IND * CYEAR + CYEAR * LVST_IND + T1_42_IND * 
    CYEAR + CYEAR * OTHR_IND + T1_45_IND * CYEAR + T1_41_IND * 
    CYEAR + CYEAR * URBAN, data=df_trimmed)
