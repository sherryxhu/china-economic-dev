...
```{r}
# no PRIMARY
m1 = lmer(log(THOUSANDS_SHIFTED) ~ CYEAR + URBAN + T1 + (1 + CYEAR|HHID), data=df, REML=FALSE)

# PRIMARY
m2 = lmer(log(THOUSANDS_SHIFTED) ~ CYEAR + URBAN + T1 + PRIMARY +(1 + CYEAR|HHID), data=df, REML=FALSE)
